...
// ===========================
// Pathfinder: TestCase18.java
// ===========================
// Checks paths through maze18.txt.
...
public class TestCase18
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		char [][] maze = readMaze("input_files/maze18.txt");
		HashSet<String> solutionPaths = readSolutions("input_files/maze18-all-paths.txt");
