...
// ===========================
// Pathfinder: TestCase15.java
// ===========================
// Checks paths through maze15.txt.
...
public class TestCase15
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		char [][] maze = readMaze("input_files/maze15.txt");
		HashSet<String> solutionPaths = readSolutions("input_files/maze15-all-paths.txt");
