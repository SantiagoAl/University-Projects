...
// ===========================
// Pathfinder: TestCase22.java
// ===========================
// Checks paths through maze22.txt.
...
public class TestCase22
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		char [][] maze = readMaze("input_files/maze22.txt");
		HashSet<String> solutionPaths = readSolutions("input_files/maze22-all-paths.txt");
