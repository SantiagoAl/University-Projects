...
// ===========================
// Pathfinder: TestCase10.java
// ===========================
// Checks paths through maze10.txt. This test case also checks paths through
...
// (Indeed, there are no paths through maze10.txt.)
...
public class TestCase10
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		singleTest("input_files/maze10.txt", "input_files/maze06-all-paths.txt");
		singleTest("input_files/maze03.txt", "input_files/maze03-all-paths.txt");
	}
}
