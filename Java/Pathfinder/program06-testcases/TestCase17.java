...
// ===========================
// Pathfinder: TestCase17.java
// ===========================
// Checks paths through maze17.txt.
...
public class TestCase17
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		char [][] maze = readMaze("input_files/maze17.txt");
		HashSet<String> solutionPaths = readSolutions("input_files/maze17-all-paths.txt");
