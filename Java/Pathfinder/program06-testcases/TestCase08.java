...
// ===========================
// Checks paths through maze08.txt. This test case also checks paths through
...
// (Indeed, there are no paths through maze08.txt.)
...
public class TestCase08
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		singleTest("input_files/maze08.txt", "input_files/maze06-all-paths.txt");
		singleTest("input_files/maze03.txt", "input_files/maze03-all-paths.txt");
	}
}
