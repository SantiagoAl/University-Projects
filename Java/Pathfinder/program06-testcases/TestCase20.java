...
// ===========================
// Pathfinder: TestCase20.java
// ===========================
// Checks paths through maze20.txt.
...
public class TestCase20
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		char [][] maze = readMaze("input_files/maze20.txt");
		HashSet<String> solutionPaths = readSolutions("input_files/maze20-all-paths.txt");
