...
// ===========================
// Checks paths through maze06.txt. This test case also checks paths through
...
// (Indeed, there are no paths through maze06.txt.)
...
public class TestCase06
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		singleTest("input_files/maze06.txt", "input_files/maze06-all-paths.txt");
		singleTest("input_files/maze03.txt", "input_files/maze03-all-paths.txt");
	}
}
