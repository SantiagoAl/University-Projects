...
// ===========================
// Pathfinder: TestCase16.java
// ===========================
// Checks paths through maze16.txt.
...
public class TestCase16
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		char [][] maze = readMaze("input_files/maze16.txt");
		HashSet<String> solutionPaths = readSolutions("input_files/maze16-all-paths.txt");
