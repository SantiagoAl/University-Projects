...
// ===========================
// Pathfinder: TestCase21.java
// ===========================
// Checks paths through maze21.txt.
...
public class TestCase21
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		char [][] maze = readMaze("input_files/maze21.txt");
		HashSet<String> solutionPaths = readSolutions("input_files/maze21-all-paths.txt");
